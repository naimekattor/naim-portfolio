    ...
    <>
      <div className="relative h-auto w-full flex  justify-center bg-black">
        ...
        <div className="absolute ">
          <div className='w-[100%] mx-auto lg:px-[15%] md:px-[10%] px-[2%] h-[100%]'>
            ...
            <div className='flex lg:flex-row flex-col gap-4'>
              ...
              <div className=' relative'>
                ...
                <div className='bg-[#51e5a8] py-[50px] md:px-[60px] px-[40px] lg:absolute right-[20px] bottom-0 rounded flex gap-4 items-center justify-center'>
